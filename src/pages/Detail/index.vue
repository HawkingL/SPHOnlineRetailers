          ...
          <div class="goodsDetail">
            ...
            <div class="support">
              ...
              <div class="supportArea">
                ...
                <div class="fixWidth">甘肃省 兰州市 七里河区</div>
              </div>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      //给子组件的数据
      skuImageList() {
        //如果skuInfo的数据没有及时返回时需要给skuImageList初始化，不然会出现报错
    ...
    methods: {
      ...
      //表单元素修改产品个数
      changeSkuNum(event) {
        //让用户输入进来的文本*1，如果是字符串结果为NAN，如果是数字结果还是数字
      ...
      async addShopCar() {
        //1.发请求将产品添加到服务器的数据库
        //2.当服务器存储成功时进行路由跳转，当服务器存储失败时给用户进行提示
        /* *************************** */
        //捕获错误
        try {
          //需要监视的代码
